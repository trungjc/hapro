...
<div class="wrap">
  <div id="icon-plugins" class="icon32"></div>
	...
	<div class="tablenav">
	  <h2>
		<a class="button add-new-h2" href="<?php echo ELP_ADMINURL; ?>?page=elp-configuration"><?php _e('Back', 'email-posts-to-subscribers'); ?></a>
		<a class="button add-new-h2" href="<?php echo ELP_ADMINURL; ?>?page=elp-configuration&ac=edit&did=<?php echo $did; ?>"><?php _e('Edit', 'email-posts-to-subscribers'); ?></a>
